...
<head>
    <meta charset="UTF-8">
    <title>BenchmarkJS Example</title>
    <script src="benchmarkjs.js"></script>
</head>
<body>
    <h1>BenchmarkJS Example</h1>
    <pre id="results">processing...</pre>
    <script>
        "use strict";
        benchmarkjs.options({
            time: 4000
        ...
        document.getElementById('results').innerHTML = JSON.stringify(benchmarkjs.results, null, 4);
    </script>
</body>
</html>